...
function populateCountries(countryElementId, stateElementId){
  ...
  countryElement.options[0] = new Option('India','0');
  for (var i = 0; i < country_arr.length; i++) {
    countryElement.options[i] = new Option(country_arr[i],country_arr[i]);
  }
