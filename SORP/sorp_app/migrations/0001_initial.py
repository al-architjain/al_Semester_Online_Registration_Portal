    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intermediate_pass_year', models.IntegerField(default=sorp_app.models.currYear)),
                ...
                ('category_admission', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='admission', to='sorp_app.Category')),
                ('category_main', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='main', to='sorp_app.Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.OneToOneField(default=0, on_delete=django.db.models.deletion.CASCADE, to='sorp_app.StudentInfo')),
            ],
        ),
        migrations.CreateModel(
            name='Subjects',
        ...
        migrations.AddField(
            model_name='result',
            name='roll_no',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sorp_app.StudentInfo', to_field='roll_no'),
        ),
        migrations.AddField(
            model_name='due',
            name='roll_no',
